...
// --- Komponen Ikon SVG (Tidak perlu diubah) ---
          ...
          <div className="bg-dark-bg-medium p-8 rounded-2xl shadow-deep" data-animate="slideInLeft" data-delay="400">
            ...
            <form ref={form} onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input type="text" id="name" name="name" className="input-style w-full py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-accent-medium" placeholder="Your Name" required />
              </div>
              <div>
                <label htmlFor="email" className="block text-gray-300 text-sm font-bold mb-2">Email</label>
                <input type="email" id="email" name="email" className="input-style w-full py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-accent-medium" placeholder="your.email@example.com" required />
              </div>
              <div>
                <label htmlFor="message" className="block text-gray-300 text-sm font-bold mb-2">Message</label>
                <textarea id="message" name="message" rows="6" className="input-style w-full py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-accent-medium" placeholder="Your message..." required></textarea>
              </div>
              ...
              {status && status !== 'Sending...' && <p className={`text-center mt-4 ${status.includes('successfully') ? 'text-green-400' : 'text-red-400'}`}>{status}</p>}
            </form>
          </div>
        </div>
      </div>
