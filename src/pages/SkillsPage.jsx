...
// --- Data for the skills, separated for easy editing ---

const technicalSkills = [
  { name: 'Laravel & PHP', level: 'Advanced', width: '90%' },
  { name: 'Java', level: 'Proficient', width: '80%' },
  { name: 'HTML & CSS (Tailwind CSS)', level: 'Expert', width: '95%' },
  { name: 'Database (MySQL, PostgreSQL)', level: 'Proficient', width: '75%' },
  { name: 'IoT', level: 'Advanced', width: '90%' },
  { name: 'Mikrotik', level: 'Proficient', width: '80%' },
];

const softSkills = [
  {
    icon: 'fas fa-lightbulb', // Using Font Awesome class names as placeholders
    title: 'Problem-Solving',
    description: 'Adept at dissecting complex challenges and architecting elegant, scalable solutions.',
  },
  {
    icon: 'fas fa-comments',
    title: 'Communication',
    description: 'Articulate and effective communicator, fostering clear and productive collaboration.',
  },
  {
    icon: 'fas fa-handshake',
    title: 'Teamwork',
    description: 'Proven ability to thrive in collaborative environments, contributing to shared success.',
  },
  {
    icon: 'fas fa-brain',
    title: 'Adaptability',
    description: 'Eager to learn and rapidly integrate new technologies and methodologies.',
  },
  {
    icon: 'fas fa-clock',
    title: 'Time Management',
    description: 'Highly organized and efficient, consistently delivering projects on schedule.',
  },
    {
    icon: 'fas fa-filter',
    title: 'Critical Thinking',
    description: 'Analyzes situations thoroughly to make informed decisions.',
  },
];

// --- SVG Icon Components (replaces Font Awesome) ---

const LightbulbIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-400 mr-4 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.636-6.364l-.707-.707M12 21V10a2 2 0 00-2-2H8a2 2 0 00-2 2v10m12 0v-2a2 2 0 00-2-2h-2a2 2 0 00-2 2v2" /></svg>;
              ...
              {technicalSkills.map((skill, index) => (
                <li key={skill.name}>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-base font-medium text-blue-300">{skill.level}</span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-3">
                    <div
                      className="bg-blue-500 h-3 rounded-full"
                      style={{ width: skill.width, transition: `width 1s ease-out ${index * 0.1}s` }}
                    ></div>
                  </div>
                </li>
              ))}
